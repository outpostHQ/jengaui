...
import { DialogForm, JengaDialogFormProps, DialogTrigger } from '../src/index'
import { Button } from '@jenga-ui/button'
import { Paragraph, Text } from '@jenga-ui/content'
...
const Template: StoryFn<JengaDialogFormProps> = (args) => {
  return (
    <DialogTrigger>
      <Button>Open</Button>
