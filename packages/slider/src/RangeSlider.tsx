...
import { FieldWrapper, FormFieldProps } from '@jengaui/form';
import {
...
export interface JengaRangeSliderProps
...
function RangeSlider(props: JengaRangeSliderProps, ref: DOMRef<HTMLDivElement>) {
  let {
    labelPosition,
    label,
    extra,
