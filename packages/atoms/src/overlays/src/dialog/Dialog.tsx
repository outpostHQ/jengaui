...
import { mergeProps, SlotProvider } from '@jenga-ui/core'
...
import { BASE_STYLES, BLOCK_STYLES, DIMENSION_STYLES } from 'tastycss-react'
...
function Dialog(props: JengaDialogProps, ref: DOMRef<HTMLDivElement>) {
