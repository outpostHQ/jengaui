...
import { AlertDialog, JengaAlertDialogProps } from '../alert-dialog/AlertDialog'
...
export interface DialogData
  extends Omit<JengaDialogContainerProps, 'onDismiss'>,
    Omit<JengaAlertDialogProps, 'type' | 'id'> {
  id?: number
